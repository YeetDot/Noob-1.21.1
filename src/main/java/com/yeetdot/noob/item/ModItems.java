...
import com.yeetdot.noob.item.custom.AllEffectPotion;
...
public class ModItems {
    ...
    public static final Item ALL_EFFECT_POTION = registerItem("all_effect_potion", new AllEffectPotion(new Item.Settings()));

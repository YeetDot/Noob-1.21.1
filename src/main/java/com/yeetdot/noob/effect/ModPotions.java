...
public class ModPotions {
    ...
    public static final RegistryEntry<Potion> ALL_EFFECT = registerEverythingPotion("all_effect", 100);

    public static final RegistryEntry<Potion> ALL_EFFECT_LONG = registerEverythingPotion("all_effect_long", 600);
    ...
    private static RegistryEntry<Potion> registerEverythingPotion(String name, int duration) {
        return register(name, new Potion(
                new StatusEffectInstance(ModStatusEffects.CREATIVITY, duration),
